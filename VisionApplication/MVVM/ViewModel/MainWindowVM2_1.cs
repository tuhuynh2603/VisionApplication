...
//        public static MainWindowVM2 mainWindowVM;
...
//            numTrack = VisionApplication.Application.m_nTrack;
//            num_Doc = VisionApplication.Application.m_nDoc;
...
//        {
//            int z = 0;
//            activeImageDock = MainWindowVM2.master.m_Tracks[0].m_imageViews[0];
//            for (int itrack = 0; itrack < VisionApplication.Application.m_nTrack; itrack++)
//            {
//                for (int j = 0; j < VisionApplication.Application.m_nDoc; j++)
//                {
...
//        {
//            if (MainWindowVM2.m_bSequenceRunning)
//                return;
...
//            MainWindowVM2.m_bSequenceRunning = true;
//        }
//        public void Stop_Sequence(int nTrack = (int)TRACK_TYPE.TRACK_ALL)
//        {
//            MainWindowVM2.m_bSequenceRunning = false;
//        }
...
//                master.m_Tracks[trackID].m_imageViews[0].image = master.m_Tracks[trackID].m_imageViews[0].btmSource;
//            }
//        }
...
//        {
//            if (MainWindowVM2.m_bSequenceRunning && false)
//                return;
